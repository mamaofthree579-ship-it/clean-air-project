<div class="hero">
  ...
  <div style="margin-top: 1.8rem;">
    <a href="/clean-air-project/docs/getting-started.md/" class="md-button md-button--primary">Get Started</a>
    <a href="/clean-air-project/docs/hardware/build_guide.md" class="md-button">Build Your Sensor</a>
  </div>
</div>
