...
tree_data = {
    ...
    "PM2.5_Removal_g_per_year": [15, 11, 18, 14, 8, 3],
...
pm_reduced = selected.PM2_5_Removal_g_per_year * count
...
pm_curve = selected.PM2_5_Removal_g_per_year * count * growth_curve
