"""
Unified Control & Documentation UI for Clean Air Project
Place this file at dashboard/app.py and run with:
    streamlit run app.py

Requires:
    pip install streamlit pandas numpy plotly requests pydeck markdown2
Optional for GitHub actions:
    set GITHUB_TOKEN and GITHUB_REPO in Streamlit secrets or env
"""
